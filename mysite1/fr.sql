...
--
-- Table structure for table `app1_author`
--

DROP TABLE IF EXISTS `app1_author`;
...
CREATE TABLE `app1_book` (
  ...
  `AuthorID_id` varchar(20) NOT NULL,
  PRIMARY KEY (`ISBN`),
  KEY `app1_book_6e7e6258` (`AuthorID_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-11-03 20:07:06
